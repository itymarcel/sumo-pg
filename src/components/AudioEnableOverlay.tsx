...
const AudioEnableOverlay: React.FC<AudioEnableOverlayProps> = ({ show, onEnable }) => {  
  ...
  return (
    <div
      className={`fixed inset-0 bg-black/100 backdrop-blur-2xl flex z-50 cursor-pointer ${
    ...
    >
      ...
      <div 
        className="fixed z-0 text-center w-full bottom-12 md:bottom-auto md:h-full text-white flex md:flex-col items-center justify-center text-sm font-bold mt-4"
