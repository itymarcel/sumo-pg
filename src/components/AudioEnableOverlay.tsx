    ...
    <div
      ...
      <div 
        className={`flex w-full h-full transition-all ease-super-ease-out bg-no-repeat bg-cover bg-center 
          ${show ? 'scale-100 delay-300 duration-500' : 'scale-[130%] blur-2xl delay-300 duration-500'}`}
        style={{ 
          backgroundImage: 'url(/paul.jpg)',
        }}>
        <div 
          className={`relative w-full z-10 text-center md:text-left text-black p-4 flex flex-col gap-1 transition-all ease-super-ease-out
            ${show ? 'opacity-100 delay-700 duration-1000' : 'opacity-0 blur-sm duration-200 translate-y-1'}`}>
          <div className='relative text-sumo-purple/95 drop-shadow-yellow-smooth text-[30vw] align-text-top leading-[80%] left-0.5 font-libertinus p-0 m-0 md:text-[15vw] font-extrabold'>
            SUMO
          </div>
        ...
        <div 
          className="fixed text-sumo-orange z-0 text-center w-full bottom-12 flex flex-col gap-2 items-center justify-center text-xs font-bold mt-4"
